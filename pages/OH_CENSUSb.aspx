<%@ Page 
    ...
    CodeFile="OH_CENSUSb.aspx.cs"
    Inherits="pages_OH_CENSUSb" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">   
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server" />
      ...
      <asp:Panel ID="PanelPopulateWomanList" runat="server">     
        ...
        <asp:BoundField 
           ...
           <asp:TemplateField HeaderText="Census Status">
            <ItemTemplate>
             ...
             <asp:TemplateField HeaderText="Within NNIPS">
            <ItemTemplate>
                 <asp:LinkButton
                    ID="ButtonAddToCensusWithNNIPS"
                    runat="server"
                    CssClass="btn-link btn-nnips"
                    Text="Add to Census"
                    CommandName="ButtonAddToCensusWithNNIPS"
        ...
        <asp:TemplateField HeaderText="Outside NNIPS">
            <ItemTemplate>
                <asp:LinkButton
        ...
        <asp:Panel ID="PanelCensusForm" runat="server" DefaultButton="ButtonCensusSaveData" Visible="false">
          ...
          <asp:Panel ID="PanelCensuWoman" runat="server" Visible="false">     
                 
           <asp:GridView 
                ID="GridViewCensuWoman" 
                runat="server"
                AutoGenerateColumns="false"
                CssClass="woman-grid"
                AllowSorting="false"
        ...
        <asp:BoundField 
            DataField="CensusHusbFirstNames" 
            HeaderText="Husband Name"
            ItemStyle-CssClass="cell-text" />
                    
       <asp:BoundField 
            DataField="CensusHusbLastName" 
            HeaderText="Last Name"
            ItemStyle-CssClass="cell-text" />
